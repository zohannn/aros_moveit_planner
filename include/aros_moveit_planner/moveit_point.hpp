#ifndef MOVEIT_POINT_HPP
#define MOVEIT_POINT_HPP
...
public:
     ...
     * @param xt
     */
    void getXt(vector<float>& xt);

    /**
     * @brief This method gets the y axis of the orientation frame.
     * @param yt
     */
    void getYt(vector<float>& yt);

    /**
     * @brief This method gets the y axis of the orientation frame.
     * @param zt
     */
    void getZt(vector<float>& zt);
    ...
    /**
     * @brief Get the transformation matrix from the position and the orientation
     * @param Trans
     */
...
protected:
     ...
     * @param id
     */
    void getRotAxis(vector<float>& xt, int id);
};


}// namespace moveit_planning

#endif // MOVEIT_POINT_HPP
