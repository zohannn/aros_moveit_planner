#include "../include/aros_moveit_planner/moveit_movement.hpp"
...
Movement::Movement(int type, int arm, string obj)
{
...
Movement::Movement(int type, int arm, string obj, int grip_id, bool prec)
{
...
Movement::Movement(const Movement &mov)
{
    ...
    this->obj = mov.obj;
    this->obj_init = mov.obj_init;
    this->obj_eng = mov.obj_eng;
...
void Movement::setObject(string obj)
{
...
void Movement::setObjectInit(string obj)
{
...
void Movement::setObjectEng(string obj_eng)
{
...
string Movement::getInfoLine()
{
    ...
    if (obj!="" && obj_eng!="" && grip_code!=0){
        ...
        return strType +", Arm: "+arm_info+", Object: "+obj+
                ", Object Engaged: "+obj_eng+", Grip Type: "+grip_str;
