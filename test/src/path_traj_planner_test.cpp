...
TEST(TestSuite_path_traj_planner, Test_path_traj_goal1)
{
    ros::init(argcc, argvv, "path_traj_planner_test_goal1");
    ros::NodeHandle nh;

    PathTrajectoryPlanner planner(nh);
